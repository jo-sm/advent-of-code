...
(define (opcode-proc--1 program in out pos rb i j k)
  (list
    ...
    (update-program
      ...
      (+ (translate-mode-param-pair program rb i) (translate-mode-param-pair program rb j)))
    in
    out
    (+ pos 4)
    rb
...
(define (opcode-proc--9 program in out pos rb i)
  (list
    ...
    out
    (+ pos 2)
    (+ rb (translate-mode-param-pair program rb i))
  )
)
